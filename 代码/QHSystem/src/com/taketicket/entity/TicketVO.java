...
public class TicketVO implements Serializable {
	...
	public String getTicket_takeIP() {
		return this.ticket_takeIP;
	}

	public void setTicket_takeIP(String ticket_takeIP) {
		this.ticket_takeIP = ticket_takeIP;
	}
