...
public class Ticket_TakeDate_VO implements Serializable {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((this.ticket_takeDate == null) ? 0 : this.ticket_takeDate
						.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		Ticket_TakeDate_VO other = (Ticket_TakeDate_VO) obj;
		...
		if (this.ticket_takeDate == null) {
			if (other.ticket_takeDate != null) {
				return false;
			}
		} else if (!this.ticket_takeDate.equals(other.ticket_takeDate)) {
			return false;
		}
		return true;
	}
